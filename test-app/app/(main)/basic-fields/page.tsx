...
export default function BasicFieldsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">Basic Fields Demo</h1>
        <p className="text-muted-foreground mt-2">
          Demonstrates all basic field types in edit mode: text, number, date,
          boolean, select, email, tel, currency, percentage, and textarea.
        </p>
      </div>
